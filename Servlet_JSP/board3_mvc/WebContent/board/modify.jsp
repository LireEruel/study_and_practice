<%@ page language="java" contentType="text/html; charset=UTF-8" 
	pageEncoding="UTF-8" import="com.ssafy.board.model.BoardDto, com.ssafy.board.model.service.BoardServiceImpl,  com.ssafy.board.model.service.BoardService "%>
<%
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          ...
          <input type="hidden" name="articleno" value=<%=boardDto.getArticleNo() %>  />
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="userid" name="userid" value="troment" readonly />
            </div>
            <div class="mb-3">
              <label for="subject" class="form-label">제목 : </label>
              <input type="text" class="form-control" id="subject" name="subject" value="즐거운 싸피생활!!!!" />
            </div>
            <div class="mb-3">
