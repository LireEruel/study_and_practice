  ...
  <body>
   <%@ include file="/WEB-INF/views/header.jsp"%>
    <form>
      ...
      <input type="text" name="" id="" value="${dto.ano}" readonly="readonly" />
      <br />
      <label for="usernumber" class="inputtitle">학번</label>
      <input type="text" name="" id="" value="${dto.usernumber}" readonly="readonly" />
      <br />
      ...
      <input type="text" name="" id="" value="${dto.issuedate}" readonly="readonly" />
      <br />
      <label for="issue" class="inputtitle">사유</label>
      <input type="text" name="" id="" value="${dto.issue}" readonly="readonly" />
      <br />
    </form>
